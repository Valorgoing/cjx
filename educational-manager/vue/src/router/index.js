...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'work', name: 'Work', meta: { name: '组内任务' }, component: () => import('../views/manager/Work.vue') },
      ...
      { path: 'department', name: 'Department', meta: { name: '小组信息' }, component: () => import('../views/manager/Department') },
      ...
      { path: 'teamwork', name: 'Teamwork', meta: { name: '组内任务提交' }, component: () => import('../views/manager/Teamwork') },
