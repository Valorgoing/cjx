...
<!--    <div class="table">-->
    ...
    <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="clubName" label="小组名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="status" label="小组角色" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="clubName" label="小组名称">
            <el-input v-model="form.clubName" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="status" label="小组角色">
          <el-select v-model="form.status" placeholder="请选择角色" style="width: 100%">
            ...
            <el-option label="小组组长" value="小组组长"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        status: [
          {required: true, message: '请输入小组角色', trigger: 'blur'},
        ],
      },
      ids: [],
      courseData: [],
