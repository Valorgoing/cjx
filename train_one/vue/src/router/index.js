...
const routes = [
    ...
    {path: '/register', name: 'Register', meta: {name: '注册'}, component: () => import('../views/Register.vue')},  // 确保你的路径和文件名正确
    {path: '*', name: '404', meta: {name: '无法访问'}, component: () => import('../views/404.vue')}  // 确保你的路径和文件名正确
]
